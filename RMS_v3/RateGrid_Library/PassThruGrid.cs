...
{
	/// <summary>
	/// PassThruGrid displays a data table of PassThru rates using $ as rate
	/// </summary>
	public class PassThruGrid : RateGrid
	{
		#region "Variables"
		...
		public PassThruGrid(string mappingName, string captionTxt) : base(mappingName, captionTxt)
		{
