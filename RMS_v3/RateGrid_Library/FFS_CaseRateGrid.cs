...
{
	/// <summary>
	/// Summary description for FFS_CaseRateGrid.
	/// </summary>
	public class FFS_CaseRateGrid : RateGrid
	{
		/// <summary> 
		...
		public FFS_CaseRateGrid(string mappingName, string captionTxt) : base(mappingName, captionTxt)
		{
		...
		private void setupColumns()
		{
			...
			tCol = new DataGridTextBoxColumn();
			tCol.HeaderText = "LOS";
			tCol.MappingName = "LOS";

			tCol.Alignment = System.Windows.Forms.HorizontalAlignment.Right;
			tCol.Width = Convert.ToInt16(rateDataGrid.Width * .05);

			this.rateDataGrid.TableStyles[0].GridColumnStyles.Add(tCol);

			tCol = new DataGridTextBoxColumn();
			tCol.HeaderText = "Addtnl Day";
			tCol.MappingName = "AddtnlDayRate";
