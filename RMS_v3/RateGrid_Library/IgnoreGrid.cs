...
{
	/// <summary>
	/// IgnoreGrid displays a data table of Ignore Rates
	/// </summary>
	public class IgnoreGrid : RateGrid
	{
		#region "Variables"
		...
		public IgnoreGrid(string mappingName, string captionTxt) : base(mappingName, captionTxt)
		{	
