...
{
	/// <summary>
	/// Summary description for BaseRateGrid.
	/// </summary>
	public class BaseRateGrid : RateGrid
	{
		#region "Variables"
		...
		public BaseRateGrid(string mappingName, string captionTxt) : base(mappingName, captionTxt)
	{
