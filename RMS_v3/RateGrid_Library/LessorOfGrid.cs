...
{
	/// <summary>
	/// LessorOfGrid displays a datatable of Lessor Of rates
	/// </summary>
	public class LessorOfGrid : RateGrid
	{
		#region "Variables"
		...
		public LessorOfGrid(string mappingName, string captionTxt) : base(mappingName, captionTxt)
	{	
		...
		private void setupColumns()
		{
			...
			tCol.Width = Convert.ToInt16(rateDataGrid.Width * .5);
