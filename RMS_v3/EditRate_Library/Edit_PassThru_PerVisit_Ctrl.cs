...
{
	/// <summary>
	/// Summary description for Edit_PassThru_PerVisit.
	/// </summary>
	public class Edit_PassThru_PerVisit_Ctrl : Edit_Rate_Ctrl
	{
		...
		public Edit_PassThru_PerVisit_Ctrl()
		{
