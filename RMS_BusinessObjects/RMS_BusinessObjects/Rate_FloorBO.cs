...
{
	/// <summary>
	/// Summary description for Rate_FloorBO.
	/// </summary>
	public class Rate_FloorBO : RateBO
	{
		#region "Variables"
		...
		public Rate_FloorBO() : base()	{}
		public Rate_FloorBO(int id) : base(id) {}
		public Rate_FloorBO(int id, int in_RateSchedID) : base(id, in_RateSchedID) {}
		public Rate_FloorBO(int id, int in_RateSchedID, string in_RateName, string in_RateCategory, string in_RateType, char in_InOut, CodesBO in_RateCodes, double in_Rate) : base(id, in_RateSchedID, in_RateName, in_RateCategory, in_RateType, in_InOut, in_RateCodes)
	{
		this.Rate = in_Rate;
	}
