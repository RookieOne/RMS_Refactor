...
{
	/// <summary>
	/// Summary description for Rate_IgnoreBO.
	/// </summary>
	public class Rate_IgnoreBO : RateBO
	{
		#region "Variables"
		...
		public Rate_IgnoreBO() : base()	{}
		public Rate_IgnoreBO(int id) : base(id) {}
		public Rate_IgnoreBO(int id, int in_RateSchedID) : base(id, in_RateSchedID) {}
		public Rate_IgnoreBO(int id, int in_RateSchedID, string in_RateName, string in_RateCategory, string in_RateType, char in_InOut, CodesBO in_RateCodes) : base(id, in_RateSchedID, in_RateName, in_RateCategory, in_RateType, in_InOut, in_RateCodes)
	{	}
