...
{
	/// <summary>
	/// Summary description for Rate_FFS_Out_POCBO.
	/// </summary>
	public class Rate_FFS_Out_POCBO : Rate_W_PassThruBO
	{
		#region "Variables"
		...
		public Rate_FFS_Out_POCBO() : base()	{}
		public Rate_FFS_Out_POCBO(int id) : base(id) {}
		public Rate_FFS_Out_POCBO(int id, int in_RateSchedID) : base(id, in_RateSchedID) {}
		public Rate_FFS_Out_POCBO(int id, int in_RateSchedID, string in_RateName, string in_RateCategory, string in_RateType, char in_InOut, CodesBO in_RateCodes, double in_Rate, int in_Priority) : base(id, in_RateSchedID, in_RateName, in_RateCategory, in_RateType, in_InOut, in_RateCodes)
	{
		this.Rate = in_Rate;
	...
	public override System.Collections.ArrayList getDataColumns()
{
	...
	columnsList.Add(new DataColumn("Priority", Type.GetType("System.Int16")));	
